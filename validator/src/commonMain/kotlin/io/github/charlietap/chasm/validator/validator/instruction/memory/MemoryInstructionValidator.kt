...
internal inline fun MemoryInstructionValidator(
    ...
    crossinline i32Load8SValidator: Validator<MemoryInstruction.I32Load8S>,
    crossinline i32Load8UValidator: Validator<MemoryInstruction.I32Load8U>,
    crossinline i32Load16SValidator: Validator<MemoryInstruction.I32Load16S>,
    crossinline i32Load16UValidator: Validator<MemoryInstruction.I32Load16U>,
    crossinline i32LoadValidator: Validator<MemoryInstruction.I32Load>,
    crossinline i64Load8SValidator: Validator<MemoryInstruction.I64Load8S>,
    crossinline i64Load8UValidator: Validator<MemoryInstruction.I64Load8U>,
    crossinline i64Load16SValidator: Validator<MemoryInstruction.I64Load16S>,
    crossinline i64Load16UValidator: Validator<MemoryInstruction.I64Load16U>,
    crossinline i64Load32SValidator: Validator<MemoryInstruction.I64Load32S>,
    crossinline i64Load32UValidator: Validator<MemoryInstruction.I64Load32U>,
    crossinline i64LoadValidator: Validator<MemoryInstruction.I64Load>,
    crossinline f32LoadValidator: Validator<MemoryInstruction.F32Load>,
    crossinline f64LoadValidator: Validator<MemoryInstruction.F64Load>,
    crossinline i32Store8Validator: Validator<MemoryInstruction.I32Store8>,
    crossinline i32Store16Validator: Validator<MemoryInstruction.I32Store16>,
    crossinline i32StoreValidator: Validator<MemoryInstruction.I32Store>,
    crossinline i64Store8Validator: Validator<MemoryInstruction.I64Store8>,
    crossinline i64Store32Validator: Validator<MemoryInstruction.I64Store32>,
    crossinline i64Store16Validator: Validator<MemoryInstruction.I64Store16>,
    crossinline i64StoreValidator: Validator<MemoryInstruction.I64Store>,
    crossinline f32StoreValidator: Validator<MemoryInstruction.F32Store>,
    crossinline f64StoreValidator: Validator<MemoryInstruction.F64Store>,
