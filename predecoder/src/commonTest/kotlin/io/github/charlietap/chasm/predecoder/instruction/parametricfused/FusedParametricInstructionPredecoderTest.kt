...
class FusedParametricInstructionPredecoderTest {
    ...
    fun `predecodes select with mixed immediates and frame slots without using caches`() {
        ...
        val dispatchable = FusedParametricInstructionPredecoder(context, instruction).value
