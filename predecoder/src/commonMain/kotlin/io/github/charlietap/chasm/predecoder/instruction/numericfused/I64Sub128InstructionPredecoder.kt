...
import io.github.charlietap.chasm.runtime.instruction.FusedNumericInstruction.I64Sub128

internal fun I64Sub128InstructionPredecoder(
    context: PredecodingContext,
    instruction: FusedNumericInstruction.I64Sub128,
    loadFactory: LoadFactory = ::LoadFactory,
    storeFactory: StoreFactory = ::StoreFactory,
): Result<DispatchableInstruction, ModuleTrapError> = I64Sub128InstructionPredecoder(
    context = context,
    instruction = instruction,
    loadFactory = loadFactory,
    storeFactory = storeFactory,
    dispatcher = ::I64Sub128Dispatcher,
)

internal inline fun I64Sub128InstructionPredecoder(
    context: PredecodingContext,
    instruction: FusedNumericInstruction.I64Sub128,
    crossinline loadFactory: LoadFactory,
    crossinline storeFactory: StoreFactory,
    crossinline dispatcher: Dispatcher<I64Sub128>,
