...
import io.github.charlietap.chasm.runtime.instruction.ParametricSuperInstruction as RuntimeFusedParametricInstruction

internal fun ParametricSuperInstructionPredecoder(
    context: PredecodingContext,
    instruction: ParametricSuperInstruction,
): Result<DispatchableInstruction, ModuleTrapError> = binding {
    when (instruction) {
        is ParametricSuperInstruction.Select -> strictSelectInstruction(instruction)
    }
}
