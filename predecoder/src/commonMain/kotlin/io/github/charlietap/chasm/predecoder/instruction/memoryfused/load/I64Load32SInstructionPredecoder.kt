...
import io.github.charlietap.chasm.executor.runtime.instruction.FusedMemoryInstruction.I64Load32S
...
internal inline fun I64Load32SInstructionPredecoder(
    ...
    dispatcher(I64Load32S(address, destination, memory, memArg))
}
