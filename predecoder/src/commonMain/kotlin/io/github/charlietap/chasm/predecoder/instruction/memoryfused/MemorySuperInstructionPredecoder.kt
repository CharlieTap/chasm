...
import io.github.charlietap.chasm.runtime.instruction.MemorySuperInstruction as RuntimeFusedMemoryInstruction

internal fun MemorySuperInstructionPredecoder(
    context: PredecodingContext,
    instruction: MemorySuperInstruction,
): Result<DispatchableInstruction, ModuleTrapError> = binding {
    when (instruction) {
        is MemorySuperInstruction.I32Load -> strictMemoryLoad(
            context = context,
        ...
        is MemorySuperInstruction.I64Load -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.F32Load -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.F64Load -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I32Load8S -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I32Load8U -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I32Load16S -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I32Load16U -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Load8S -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Load8U -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Load16S -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Load16U -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Load32S -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Load32U -> strictMemoryLoad(
            context = context,
            addressOperand = instruction.addressOperand,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.MemorySize -> strictMemorySizeInstruction(
            context = context,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ).bind()
        is MemorySuperInstruction.MemoryGrow -> strictMemoryGrowInstruction(
            context = context,
            pagesToAdd = instruction.pagesToAdd,
            destination = instruction.destination,
            memoryIndex = instruction.memoryIndex,
        ).bind()
        is MemorySuperInstruction.MemoryInit -> strictMemoryInitInstruction(
            context = context,
        ...
        is MemorySuperInstruction.MemoryCopy -> strictMemoryCopyInstruction(
            context = context,
            bytesToCopy = instruction.bytesToCopy,
            sourceOffset = instruction.sourceOffset,
            destinationOffset = instruction.destinationOffset,
        ...
        is MemorySuperInstruction.MemoryFill -> strictMemoryFillInstruction(
            context = context,
        ...
        is MemorySuperInstruction.I32Store -> strictI32MemoryStore(
            context = context,
        ...
        is MemorySuperInstruction.I64Store -> strictI64MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.F32Store -> strictF32MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.F64Store -> strictF64MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I32Store8 -> strictI32MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I32Store16 -> strictI32MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Store8 -> strictI64MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Store16 -> strictI64MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
        ...
        is MemorySuperInstruction.I64Store32 -> strictI64MemoryStore(
            context = context,
            valueOperand = instruction.valueOperand,
            addressOperand = instruction.addressOperand,
            memoryIndex = instruction.memoryIndex,
