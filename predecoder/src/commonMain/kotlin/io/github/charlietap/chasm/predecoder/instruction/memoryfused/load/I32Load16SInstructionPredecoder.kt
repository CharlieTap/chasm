...
import io.github.charlietap.chasm.executor.runtime.instruction.FusedMemoryInstruction.I32Load16S
...
internal inline fun I32Load16SInstructionPredecoder(
    ...
    dispatcher(I32Load16S(address, destination, memory, memArg))
}
