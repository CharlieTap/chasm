...
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Abs
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Add
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Ceil
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32ConvertI32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32ConvertI32U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32ConvertI64S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32ConvertI64U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Copysign
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32DemoteF64
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Div
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Eq
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Floor
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Ge
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Gt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Le
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Lt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Max
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Min
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Mul
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Ne
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Nearest
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Neg
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Sqrt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Sub
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F32Trunc
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Abs
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Add
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Ceil
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64ConvertI32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64ConvertI32U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64ConvertI64S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64ConvertI64U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Copysign
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Div
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Eq
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Floor
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Ge
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Gt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Le
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Lt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Max
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Min
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Mul
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Ne
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Nearest
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Neg
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64PromoteF32
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Sqrt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Sub
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.F64Trunc
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Add
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32And
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Clz
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Ctz
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32DivS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32DivU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Eq
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Eqz
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Extend16S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Extend8S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32GeS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32GeU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32GtS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32GtU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32LeS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32LeU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32LtS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32LtU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Mul
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Ne
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Or
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Popcnt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32RemS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32RemU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Rotl
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Rotr
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Shl
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32ShrS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32ShrU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Sub
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncF32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncF32U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncF64S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncF64U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncSatF32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncSatF32U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncSatF64S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32TruncSatF64U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32WrapI64
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I32Xor
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Add
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64And
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Clz
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Ctz
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64DivS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64DivU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Eq
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Eqz
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Extend16S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Extend32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Extend8S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64ExtendI32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64ExtendI32U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64GeS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64GeU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64GtS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64GtU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64LeS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64LeU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64LtS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64LtU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Mul
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Ne
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Or
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Popcnt
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64RemS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64RemU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Rotl
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Rotr
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Shl
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64ShrS
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64ShrU
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Sub
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncF32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncF32U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncF64S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncF64U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncSatF32S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncSatF32U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncSatF64S
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64TruncSatF64U
import io.github.charlietap.chasm.ir.instruction.NumericSuperInstruction.I64Xor
