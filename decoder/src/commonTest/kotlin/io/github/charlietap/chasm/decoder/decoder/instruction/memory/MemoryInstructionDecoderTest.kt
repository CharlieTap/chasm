...
class MemoryInstructionDecoderTest {
    ...
    fun `can decode memarg memory instructions`() {
        ...
        val opcodeInstructionMap = mapOf(
            I32_LOAD to MemoryInstruction.Load.I32.I32Load(expectedMemoryIndex, expectedMemArg),
            I64_LOAD to MemoryInstruction.Load.I64.I64Load(expectedMemoryIndex, expectedMemArg),
            F32_LOAD to MemoryInstruction.Load.F32.F32Load(expectedMemoryIndex, expectedMemArg),
            F64_LOAD to MemoryInstruction.Load.F64.F64Load(expectedMemoryIndex, expectedMemArg),
            I32_LOAD8_S to MemoryInstruction.Load.I32.I32Load8S(expectedMemoryIndex, expectedMemArg),
            I32_LOAD8_U to MemoryInstruction.Load.I32.I32Load8U(expectedMemoryIndex, expectedMemArg),
            I32_LOAD16_S to MemoryInstruction.Load.I32.I32Load16S(expectedMemoryIndex, expectedMemArg),
            I32_LOAD16_U to MemoryInstruction.Load.I32.I32Load16U(expectedMemoryIndex, expectedMemArg),
            I64_LOAD8_S to MemoryInstruction.Load.I64.I64Load8S(expectedMemoryIndex, expectedMemArg),
            I64_LOAD8_U to MemoryInstruction.Load.I64.I64Load8U(expectedMemoryIndex, expectedMemArg),
            I64_LOAD16_S to MemoryInstruction.Load.I64.I64Load16S(expectedMemoryIndex, expectedMemArg),
            I64_LOAD16_U to MemoryInstruction.Load.I64.I64Load16U(expectedMemoryIndex, expectedMemArg),
            I64_LOAD32_S to MemoryInstruction.Load.I64.I64Load32S(expectedMemoryIndex, expectedMemArg),
            I64_LOAD32_U to MemoryInstruction.Load.I64.I64Load32U(expectedMemoryIndex, expectedMemArg),
            I32_STORE to MemoryInstruction.Store.I32.I32Store(expectedMemoryIndex, expectedMemArg),
            I64_STORE to MemoryInstruction.Store.I64.I64Store(expectedMemoryIndex, expectedMemArg),
            F32_STORE to MemoryInstruction.Store.F32.F32Store(expectedMemoryIndex, expectedMemArg),
            F64_STORE to MemoryInstruction.Store.F64.F64Store(expectedMemoryIndex, expectedMemArg),
            I32_STORE8 to MemoryInstruction.Store.I32.I32Store8(expectedMemoryIndex, expectedMemArg),
            I32_STORE16 to MemoryInstruction.Store.I32.I32Store16(expectedMemoryIndex, expectedMemArg),
            I64_STORE8 to MemoryInstruction.Store.I64.I64Store8(expectedMemoryIndex, expectedMemArg),
            I64_STORE16 to MemoryInstruction.Store.I64.I64Store16(expectedMemoryIndex, expectedMemArg),
