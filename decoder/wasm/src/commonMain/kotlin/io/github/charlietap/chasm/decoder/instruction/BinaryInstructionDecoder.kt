...
import io.github.charlietap.chasm.decoder.instruction.control.BinaryControlInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.control.ControlInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.memory.BinaryMemoryInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.memory.MemoryInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.numeric.BinaryNumericInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.numeric.NumericInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.parametric.BinaryParametricInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.parametric.ParametricInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.prefix.BinaryPrefixInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.prefix.PrefixInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.reference.BinaryReferenceInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.reference.ReferenceInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.table.BinaryTableInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.table.TableInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.variable.BinaryVariableInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.variable.VariableInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.vector.BinaryVectorInstructionDecoder
import io.github.charlietap.chasm.decoder.instruction.vector.VectorInstructionDecoder
import io.github.charlietap.chasm.error.InstructionDecodeError
import io.github.charlietap.chasm.error.WasmDecodeError
import io.github.charlietap.chasm.reader.WasmBinaryReader

fun BinaryInstructionDecoder(
