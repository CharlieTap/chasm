...
import io.github.charlietap.chasm.error.ValueDecodeError

fun ByteArray.toFloatLe(): Result<Float, ValueDecodeError.InvalidFloat> = binding {
...
fun ByteArray.toDoubleLe(): Result<Double, ValueDecodeError.InvalidDouble> = binding {
