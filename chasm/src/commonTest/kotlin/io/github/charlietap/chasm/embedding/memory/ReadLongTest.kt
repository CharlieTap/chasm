...
class ReadLongTest {
    ...
    @Test
    fun `can read a long from a memory instance`() {
        ...
        val bytesReader: BytesReader = { _memory, _buffer, _memoryPointer, _bytesToRead, _bufferPointer ->
            ...
            byteArrayOf(0x75, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
        }

        val expected: Result<Long, ModuleTrapError> = Ok(expectedLong)
