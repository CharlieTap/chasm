...
class WriteDoubleTest {

    @Test
    fun `can write a double to a memory instance`() {
        ...
        val bytesWriter: BytesWriter = { _memory, _size, _buffer, _pointer, _bytes, _bufferPointer ->
            ...
            assertContentEquals(byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x5D, 0x40), _buffer)
