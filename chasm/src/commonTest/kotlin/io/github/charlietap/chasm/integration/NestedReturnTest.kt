...
class NestedReturnTest {

    @Test
    fun `can run a wasm file with nested return statements and return a correct result`() {

        val byteStream = Resource("src/commonTest/resources/nested_return.wasm").readBytes()
        ...
        val result = Chasm.module(reader)
            .flatMap { module ->
                ...
                Chasm.invoke(store, instance, "nested_return", listOf(NumberValue.I32(4)))
            }
