...
class RefCastExecutorImplTest {
    ...
    fun `can execute the RefCast instruction and return the reference value when types match`() {
        ...
        val actual = RefCastExecutorImpl(store, stack, referenceType, referenceTypeSubstitutor, referenceTypeMatcher, typeOfReferenceValue)
