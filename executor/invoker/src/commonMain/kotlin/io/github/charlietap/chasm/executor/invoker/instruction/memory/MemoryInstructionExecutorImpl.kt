...
internal fun MemoryInstructionExecutorImpl(
    ...
    when (instruction) {
        ...
        is MemoryInstruction.MemoryGrow -> memoryGrowExecutor(store, stack, instruction).bind()
        is MemoryInstruction.MemoryFill -> memoryFillExecutor(store, stack, instruction).bind()
        is MemoryInstruction.MemoryCopy -> memoryCopyExecutor(store, stack, instruction).bind()
        is MemoryInstruction.MemorySize -> memorySizeExecutor(store, stack, instruction).bind()
        is MemoryInstruction.I32Load -> i32LoadExecutor(store, stack, instruction).bind()
        is MemoryInstruction.I32Load8S -> i32SizedSignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 1).bind()
        is MemoryInstruction.I32Load8U -> i32SizedUnsignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 1).bind()
        is MemoryInstruction.I32Load16S -> i32SizedSignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 2).bind()
        is MemoryInstruction.I32Load16U -> i32SizedUnsignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 2).bind()
        is MemoryInstruction.I32Store -> i32StoreExecutor(store, stack, instruction).bind()
        is MemoryInstruction.I32Store8 -> i32StoreSizedExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 1).bind()
        is MemoryInstruction.I32Store16 -> i32StoreSizedExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 2).bind()
        is MemoryInstruction.I64Load -> i64LoadExecutor(store, stack, instruction).bind()
        is MemoryInstruction.I64Load8S -> i64SizedSignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 1).bind()
        is MemoryInstruction.I64Load8U -> i64SizedUnsignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 1).bind()
        is MemoryInstruction.I64Load16S -> i64SizedSignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 2).bind()
        is MemoryInstruction.I64Load16U -> i64SizedUnsignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 2).bind()
        is MemoryInstruction.I64Load32S -> i64SizedSignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 4).bind()
        is MemoryInstruction.I64Load32U -> i64SizedUnsignedLoadExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 4).bind()
        is MemoryInstruction.I64Store -> i64StoreExecutor(store, stack, instruction).bind()
        is MemoryInstruction.I64Store8 -> i64StoreSizedExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 1).bind()
        is MemoryInstruction.I64Store16 -> i64StoreSizedExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 2).bind()
        is MemoryInstruction.I64Store32 -> i64StoreSizedExecutor(store, stack, instruction.memoryIndex, instruction.memArg, 4).bind()
