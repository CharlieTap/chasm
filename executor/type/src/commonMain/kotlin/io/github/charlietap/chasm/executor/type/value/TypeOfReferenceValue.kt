...
import io.github.charlietap.chasm.executor.type.extremas.BottomOf
import io.github.charlietap.chasm.executor.type.extremas.BottomOfHeapType
...
internal fun TypeOfReferenceValue(
    ...
    is ReferenceValue.Null -> bottomOfHeapType(value.heapType, moduleInstance)?.let(::RefNull)
