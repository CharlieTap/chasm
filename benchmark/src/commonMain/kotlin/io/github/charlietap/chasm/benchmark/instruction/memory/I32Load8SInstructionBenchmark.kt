...
import io.github.charlietap.chasm.fixture.runtime.instruction.i32Load8SRuntimeInstruction
...
class I32Load8SInstructionBenchmark : StabilizedBenchmark() {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        val result = I32Load8SExecutor(vstack, cstack, store, context, instruction)
