...
import io.github.charlietap.chasm.fixture.runtime.instruction.f64LoadRuntimeInstruction
...
class F64LoadInstructionBenchmark : StabilizedBenchmark() {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        val result = F64LoadExecutor(vstack, cstack, store, context, instruction)
