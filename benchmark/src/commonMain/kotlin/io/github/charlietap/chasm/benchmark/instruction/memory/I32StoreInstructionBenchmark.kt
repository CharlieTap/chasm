...
import io.github.charlietap.chasm.fixture.runtime.instruction.i32StoreRuntimeInstruction
...
class I32StoreInstructionBenchmark : StabilizedBenchmark() {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        val result = I32StoreExecutor(vstack, cstack, store, context, instruction)
