...
import io.github.charlietap.chasm.fixture.runtime.instruction.i64LoadRuntimeInstruction
...
class I64LoadInstructionBenchmark : StabilizedBenchmark() {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        val result = I64LoadExecutor(vstack, cstack, store, context, instruction)
