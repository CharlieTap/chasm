...
import io.github.charlietap.chasm.fixture.runtime.instruction.i32LoadRuntimeInstruction
...
class I32LoadInstructionBenchmark {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        val result = I32LoadExecutor(ip, vstack, cstack, store, context, instruction)
