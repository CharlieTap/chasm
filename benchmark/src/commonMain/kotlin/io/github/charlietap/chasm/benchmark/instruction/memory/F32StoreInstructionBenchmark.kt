...
import io.github.charlietap.chasm.fixture.runtime.instruction.f32StoreRuntimeInstruction
...
class F32StoreInstructionBenchmark : StabilizedBenchmark() {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        context.vstack.pushF32(value)
        val result = F32StoreExecutor(vstack, cstack, store, context, instruction)
