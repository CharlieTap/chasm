...
import io.github.charlietap.chasm.fixture.runtime.instruction.f32LoadRuntimeInstruction
...
class F32LoadInstructionBenchmark : StabilizedBenchmark() {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        val result = F32LoadExecutor(vstack, cstack, store, context, instruction)
