...
import io.github.charlietap.chasm.fixture.runtime.instruction.i32Store8RuntimeInstruction
...
class I32Store8InstructionBenchmark {
    ...
    fun benchmark(blackhole: Blackhole) {
        ...
        val result = I32Store8Executor(ip, vstack, cstack, store, context, instruction)
